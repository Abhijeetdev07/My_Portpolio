      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center">
          <motion.div
            ...
            className="max-w-4xl p-6 min-[500px]:p-8 md:p-12 rounded-2xl border transition-all duration-500 transform hover:scale-[1.02]" style={{ backgroundColor: 'var(--bg-card-dark)' }}
          >
